...
class UniMolModel(BaseUnicoreModel):
    def __init__(self, output_dim=2, data_type='molecule', **params):
        ...
        self.FDS = FDS(feature_dim=512, start_update=0, start_smooth=1, kernel='gaussian', ks=5, sigma=2)
    ...
    def forward(
        ...
        **kwargs
        ...
        cls_repr1 = encoder_rep[:, 0, :]  # CLS token repr
        #start_smooth= 1
        #if self.training and epoch >= start_smooth:
        #    cls_repr = self.FDS.smooth(cls_repr1, labels, epoch) 
