...
def get_args():
    ...
    parser.add_argument("--agile", type=bool, default=False)
    ...
    parser.add_argument('--seq_hidden_dim', type=int, default=512)

    ''' Geometric Setting '''
    parser.add_argument('--geometry', type=bool, default=False)
    ...
    parser.add_argument("--unimol", type=bool, default=False)
    ...
    parser.add_argument('--dataset', type=str, default='lnp_unique')
    ...
    parser.add_argument("--LDS", type=bool, default=False)
    parser.add_argument("--FDS", type=bool, default=False)

    """ IFM """
    parser.add_argument("--IFM", type=bool, default=False)
    parser.add_argument("--IFM_type", type=str, default="basic", choices=["basic", "gaussian", "positional"])
